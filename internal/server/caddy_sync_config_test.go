...
func TestCaddyDNSProviderConfig(t *testing.T) {
	tests := []struct {
		...
		{"gandi", dns.Gandi, map[string]string{"gandi_api_token": " pat "}, map[string]any{"name": "gandi", "bearer_token": "pat"}},
		{"gandi-blank", dns.Gandi, map[string]string{"gandi_api_token": ""}, nil},
