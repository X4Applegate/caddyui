...
var settingsKeySection = map[string]string{
	...
	settingOIDCEnabled:        "security",
	settingOIDCIssuer:         "security",
	settingOIDCClientID:       "security",
	settingOIDCClientSecret:   "security",
	settingOIDCRedirectURL:    "security",
	settingOIDCAutoCreate:     "security",
	settingOIDCButtonLabel:    "security",
